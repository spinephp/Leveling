...
public class RegionPickerDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            try {
                if (MainFragment.mm=="1"){
                     inputReader = new InputStreamReader(context.getAssets().open("city_data.json"));
                }else if (MainFragment.mm=="2"){
                     inputReader = new InputStreamReader(context.getAssets().open("city_data1.json"));
                }
