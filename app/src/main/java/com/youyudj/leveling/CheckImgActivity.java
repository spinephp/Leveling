...
public class CheckImgActivity extends AppCompatActivity {
    ImageView img_show;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_show = (ImageView) findViewById(R.id.img_show121);
        ...
        String url = "/api/File/GetOrder?filename="+Sure_Order_Activity.img1;
        HttpFileHelper.httpGetFile(10,url,handler);
    }
